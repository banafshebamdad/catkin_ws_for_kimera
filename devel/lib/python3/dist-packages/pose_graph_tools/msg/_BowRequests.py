...
"""autogenerated by genpy from pose_graph_tools/BowRequests.msg. Do not edit."""
import codecs
import sys
...
class BowRequests(genpy.Message):
  _md5sum = "772d3c253526173250ad7a3a53433c14"
  _type = "pose_graph_tools/BowRequests"
...
string frame_id
"""
  __slots__ = ['header','source_robot_id','destination_robot_id','pose_ids']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,source_robot_id,destination_robot_id,pose_ids
    ...
    """
    if args or kwds:
      super(BowRequests, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.source_robot_id, _x.destination_robot_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.source_robot_id, _x.destination_robot_id,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
