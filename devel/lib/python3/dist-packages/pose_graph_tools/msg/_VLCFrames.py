...
"""autogenerated by genpy from pose_graph_tools/VLCFrames.msg. Do not edit."""
import codecs
import sys
...
class VLCFrames(genpy.Message):
  _md5sum = "ed62f9b44312b921eed3042e46afa35b"
  _type = "pose_graph_tools/VLCFrames"
...
float64 w
"""
  __slots__ = ['header','destination_robot_id','frames']
  _slot_types = ['std_msgs/Header','uint32','pose_graph_tools/VLCFrameMsg[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,destination_robot_id,frames
    ...
    """
    if args or kwds:
      super(VLCFrames, self).__init__(*args, **kwds)
